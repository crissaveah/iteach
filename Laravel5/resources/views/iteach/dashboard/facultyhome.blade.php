                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="view" class="collapse">
                            <li>
                                <a href="facultyViewAll.html">All</a>
                            </li>
                            <li>
                                <a href="facultyViewCourses.html">Courses</a>
                            </li>
                            <li>
                                <a href="facultyViewRooms.html">Rooms</a>
                            </li>
                            <li>
                                <a href="facultyViewInstructor.html">Instructor</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="facultyViewSchedule.html"><i class="fa fa-fw fa-table"></i> My Schedule </a>
                    </li>
                    <li>
                        <a href="facultyViewSchedule.html"><i class="fa fa-fw fa-table"></i> Upload </a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Welcome <small>{{ Auth::user()->username }}</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
